...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
        ...
        for key in bboxes:
                ...
                for jk in range(1):
#here I changed 'new_boxes.shape[0]' to '1' so that I get only one box per image
...
################# I wrote this code to get the answers in form of a csv file

df = pandas.DataFrame(data={"img_name": img_name_list, "x1": x1_list, "x2": x2_list, "y1": y1_list, "y2": y2_list})
